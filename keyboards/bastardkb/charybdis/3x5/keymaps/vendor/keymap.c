...
#define LAYOUT_LAYER_POINTER                                                                  \
    ...
    _______, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX, XXXXXXX, KC_LSFT, KC_LCTL, KC_LALT, _______, \
    KC_LGUI, DRGSCRL, SNIPING, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, SNIPING, DRGSCRL, KC_LGUI, \
 ...
 *
 * Expects a 10-key per row layout.  Adds Alt, Ctl, Shift home-row mods; Gui
 * lives on the bottom pinky keys (see `POINTER_MOD`).  The layout passed in
 ...
 *
 * Pointer layer on the outer home-row pinky keys (A, O), Gui on the outer
 * bottom-row pinky keys (Z, /).
 *
